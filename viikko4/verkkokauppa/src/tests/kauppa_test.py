...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_paatyttya_oikeat_arvot(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_2_eri_tuotetta_toinen_loppu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_nollaa(self):
        ...
        # nollaa edellisen ostoksen tiedot
        kauppa.aloita_asiointi()
    ...
    def test_uusi_viitenumero(self):
        ...
        uusi_viitenumero = pankki_mock.tilisiirto.call_args_list[1][0][1]
        pankki_mock.tilisiirto.assert_called_with("pekka", uusi_viitenumero, "12345", "33333-44455", 5)
